...
public class Patient extends Personne {
    ...
    public Patient(String _nom, String _prenom, String _numeroDeTelephone, char _sexe, long _numeroSecuriteSociale, LocalDate _dateDeNaissance, String _commentaire, Adresse _adresse) {
    ...
    public void afficher() {
        StringBuilder info = new StringBuilder();
                info.append("Sexe : ").append(displayGender()).append("\n")
